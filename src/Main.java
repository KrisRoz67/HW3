...
public class Main {
   ...
   public static Scanner scanner = new Scanner(System.in);
    ...
    public int getAbsoluteValue(int firstInput, int secondInput){ return Math.abs(firstInput-secondInput);
    }
    /**in case you need find any char **/
    public char getAskedCharOfString(String userString,int orderOfChar){ return userString.charAt(orderOfChar);
    }
    public char getFirstCharOfString(String userString){ return getAskedCharOfString(userString,0);
    }
    public char getLastCharOfString(String userString){ return getAskedCharOfString(userString,userString.length()-1);
    }
